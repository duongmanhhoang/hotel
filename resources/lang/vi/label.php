...
return [
    ...
    'post' => [
        ...
        'intro' => 'Được xây dựng vào năm 2018, Atlantic là khách sạn đầu tiên ở Đồng bằng sông Cửu Long – đồng thời 
                     cũng là khách sạn sang trọng đầu tiên và duy nhất tại đây. 
    ...
    'contact' => [
        ...
        'location' => 'Địa điểm',
        'we_are' => 'Chúng tôi',
        'system' => 'Hệ thống chi nhánh',
        'contact_desc' => 'Atlantic là khách sạn chuyên cung cấp các sản phẩm, dịch vụ tốt nhất. Với hệ thống khách sạn được thiết kế hàng đầu, hệ thống showroom có mặt ở nhiều nơi, đội ngũ nhân viên tận tình, Atlantic mang đến cho khách hàng những sản phẩm và dịch vụ chuyên nghiệp nhất',
        'hotel_system' => 'HỆ THỐNG KHÁCH SẠN',
        'contact_with' => 'Liên hệ với',
        'register_email_text' => 'Đăng kí email để nhận tin tức mới nhất từ Atlantic',
        'contact_title_desc' => 'Atlantic là khách sạn hàng đầu trong ngành nghỉ dưỡng tại khu vực Asia',
        'title' => 'Liên hệ',
        'title_intro' => 'Atlantic là khách sạn hàng đầu trong ngành nghỉ dưỡng tại khu vực Asia với hệ thống thông minh hiện đại',
    ],
