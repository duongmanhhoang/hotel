		<div class="menu-section">
			<div class="container">
				<div class="row">
					<div class="top-bar">
						<ul>
							...
							<li><a class='dropdown-button' href='#' data-activates='dropdown2'>{{$current_language->name}} <i class="fa fa-angle-down"></i></a>
							</li>
				...
				<div class="row">
					<div class="logo">
						<a href="{{ route('home') }}"><img src="{{ asset(config('common.uploads.logo')) . '/' . $inforWeb->logo }}" alt="" />
						</a>
					</div>
					<div class="menu-bar">
						<ul>
