				...
				<div class="row">
					<div class="inn-bod">
						<div class="inn-detail-p1 inn-com">
							...
							<p>Phòng gồm có một phòng khách và phòng ngủ hướng ra Hồ. Mỗi phòng đều được thiết kế với phong cách sang trọng cùng các trang thiết bị hiện đại. Đặc biệt phòng có khu vực tiếp khách riêng biệt. <br>
							Occupation max – 2 người <br>
							Surface of the room in m² or sqm – 36 sq.m</p>
							<p>Phòng được thiết kế với các trang thiết bị hiện đại, cách bày trí sang trọng và ấn tượng. Các cửa sổ rộng hướng ra phía hồ Giảng Võ thơ mộng, yên tĩnh tạo cho Quý khách cảm giác thư giãn, thoải mái. Hạng phòng này rất phù hợp cho các khách thương gia có nhu cầu lưu trú dài hạn hoặc khách từ các công ty lữ hành, phòng có cửa sổ lớn hướng ra phía Hồ thơ mộng và được thiết kế với phong cách sang trọng, trang nhã và hiện đại bao gồm một phòng ngủ, phòng khách rộng có ghế sofa lớn và có khu vệ sinh riêng biệt.</p>
						</div>
						<div class="inn-detail-p1 inn-com inn-com-list-point">
							<div class="detail-title">
								<h2>Tiện nghi phòng</h2>
								<p>Master Room được thiết kế với không gian sang trọng, dẫn đầu về mức độ tiện nghi hiện đại, dễ dàng sử dụng, đem lại cảm giác thư giãn nhất cho khách hàng.</p>
							</div>
							<ul>
						...
						<div class="inn-detail-p1 inn-com inn-com-price">
							<div class="detail-title">
								...
								<p>Đặt phòng ngay hôm nay để nhận được mức ưu đãi tốt nhất, đồng thời kèm theo những dịch vụ hàng đầu mà Atlantic mang lại cho bạn.</p>
							</div>
							<h4>Giá cho 1 đêm</h4>
							<p>Giá trên đã bao gôm VAT cùng các dịch vụ kèm theo.</p> <span>Không hoàn trả</span> <span class="inn-room-price">$600</span> </div>
						<div class="inn-detail-p1 inn-com">
							<div class="detail-title">
								<h2>Thư viện ảnh</h2>
							...
							<div class="room-photo-all">
								<div class="col-md-3 room-photo">
									<div class="gall-grid room-photo-gal"> <img class="materialboxed" data-caption="Caption" src="images/room/1.jpg" alt="" /> </div>
								</div>
								<div class="col-md-3 room-photo">
									<div class="gall-grid room-photo-gal"> <img class="materialboxed" data-caption="Caption" src="images/room/2.jpg" alt="" /> </div>
								</div>
								<div class="col-md-3 room-photo">
									<div class="gall-grid room-photo-gal"> <img class="materialboxed" data-caption="Caption" src="images/room/3.jpg" alt="" /> </div>
								</div>
								<div class="col-md-3 room-photo">
									<div class="gall-grid room-photo-gal"> <img class="materialboxed" data-caption="Caption" src="images/room/4.jpg" alt="" /> </div>
								</div>
								<div class="col-md-3 room-photo">
									<div class="gall-grid room-photo-gal"> <img class="materialboxed" data-caption="Caption" src="images/room/5.jpg" alt="" /> </div>
								</div>
								<div class="col-md-3 room-photo">
									<div class="gall-grid room-photo-gal"> <img class="materialboxed" data-caption="Caption" src="images/room/6.jpg" alt="" /> </div>
								</div>
							</div>
						</div>
						<div class="inn-detail-p1 inn-com">
									...
									<li>
										<div class="re-room-list">
											...
											<div class="col-md-6 re-room-list-2">
												<h4>Normal Rooms</h4>
												<p><b>Dịch vụ: </b>TTelevision, Wi-Fi, Hair dryer, Towels, Dining, Music, GYM and more. </p> <span><b>Includes</b> : Free Parking, Breakfast, VAT</span> <span><b>Maxinum </b> : 4 Persons</span> </div>
											<div class="col-md-3 re-room-list-3"> <span class="hot-list-p3-1">Giá cho 1 đêm</span> <span class="hot-list-p3-2">$940</span> <a href="booking.html" class="hot-page2-alp-quot-btn spec-btn-text">Book Now</a> </div>
										</div>
									</li>
									<li>
										<div class="re-room-list">
											...
											<div class="col-md-6 re-room-list-2">
												<h4>Normal Rooms</h4>
												<p><b>Dịch vụ: </b>Television, Wi-Fi, Hair dryer, Towels, Dining, Music, GYM and more.. </p> <span><b>Includes</b> : Free Parking, Breakfast, VAT</span> <span><b>Maxinum </b> : 4 Persons</span> </div>
											<div class="col-md-3 re-room-list-3"> <span class="hot-list-p3-1">Giá cho 1 đêm</span> <span class="hot-list-p3-2">$940</span> <a href="booking.html" class="hot-page2-alp-quot-btn spec-btn-text">Book Now</a> </div>
										</div>
									</li>
									<li>
						...
						<div class="inn-detail-p1 inn-com">
							...
							<a class="waves-effect waves-light wr-re-btn" href="%21.html#" data-toggle="modal" data-target="#commend"><i class="fa fa-edit"></i> Write Review</a>
						</div>
						<div class="inn-detail-p1 inn-com room-soc-share">
							<div class="detail-title">
								<h2>Chia sẻ phòng</h2>
								<p>Chia sẻ phòng Atlantic tới mọi người xung quanh bạn để mọi người đều có cơ hội có một kì nghỉ tuyệt vời nào!</p>
							</div>
							<ul>
