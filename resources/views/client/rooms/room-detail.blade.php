...
@section('content')
<div class="hp-banner"> <img src="{{ asset('bower_components/client_layout/images/detailed-banner.jpg') }}" alt=""> </div>
				...
				<div class="row">
					<div class="col-md-8">
						<div class="row">
							...
							<div class="hp-section">
								...
								<div class="hp-amini">
									<ul>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a1.png') }}" alt=""> Máy sấy tóc</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a2.png') }}" alt=""> Đồ ăn</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a3.png') }}" alt=""> Tủ lạnh</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a4.png') }}" alt="">  Internet</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a5.png') }}" alt=""> Miễn Phí ăn uống</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a6.png') }}" alt=""> Miễn phí gọi điện</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a7.png') }}" alt=""> Điều hòa</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a8.png') }}" alt=""> Xe đưa đón</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a9.png') }}" alt=""> Cafe sáng</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a10.png') }}" alt=""> Dịch vụ y tế</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a11.png') }}" alt=""> Xông hơi</li>
										<li><img src="{{ asset('bower_components/client_layout/images/icon/a12.png') }}" alt=""> Tắm bồn</li>
									</ul>
								</div>
							</div>
							<div class="hp-section">
								...
								<div class="hp-over">
									<ul class="nav nav-tabs hp-over-nav">
										<li class="active">
											<a data-toggle="tab" href="#home"><img src="{{ asset('bower_components/client_layout/images/icon/a9.png') }}" alt=""> <span class="tab-hide">Đồ ăn</span>
											</a>
										</li>
										<li>
											<a data-toggle="tab" href="#menu1"><img src="{{ asset('bower_components/client_layout/images/icon/a8.png') }}" alt=""> <span class="tab-hide">Tổng quan</span>
											</a>
										</li>
										<li>
											<a data-toggle="tab" href="#menu2"><img src="{{ asset('bower_components/client_layout/images/icon/a10.png') }}" alt=""> <span class="tab-hide">Cơ sở</span>
											</a>
										</li>
										<li>
											<a data-toggle="tab" href="#menu3"><img src="{{ asset('bower_components/client_layout/images/icon/a11.png') }}" alt=""> <span class="tab-hide">Tiện nghi khác</span>
											</a>
										</li>
									</ul>
									<div class="tab-content">
										<div id="home" class="tab-pane fade in active tab-space">
											<div class="res-menu"> <img src="{{ asset('bower_components/client_layout/images/menu/1.jpg') }}" alt="">
										...
										<div id="menu2" class="tab-pane fade tab-space">
											<div class="row">
												<div class="col-md-6 hp-ov-fac"> <img src="{{ asset('bower_components/client_layout/images/hotel/1.jpg') }}" alt=""> </div>
												<div class="col-md-6">
							...
							<div class="hp-section">
								...
								<div class="">
									<div class="h-gal">
										<ul>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{ asset('bower_components/client_layout/images/room/1.jpg') }}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{ asset('bower_components/client_layout/images/room/2.jpg') }}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{ asset('bower_components/client_layout/images/room/3.jpg') }}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{ asset('bower_components/client_layout/images/room/4.jpg') }}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{ asset('bower_components/client_layout/images/room/5.jpg') }}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{ asset('bower_components/client_layout/images/room/6.jpg') }}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{ asset('bower_components/client_layout/images/room/1.jpg') }}" alt="">
											</li>
											<li><img class="materialboxed" data-caption="Hotel Captions" src="{{ asset('bower_components/client_layout/images/room/2.jpg') }}" alt="">
							...
							<div class="hp-section">
								...
								<div class="lp-ur-all-rat">
									<ul>
										<li>
											<div class="lr-user-wr-img"> <img src="{{ asset('bower_components/client_layout/images/users/100.png') }}" alt=""> </div>
											<div class="lr-user-wr-con">
												<h6>Tran dan <span>4.5 <i class="fa fa-star" aria-hidden="true"></i></span></h6> <span class="lr-revi-date">19th January, 2019</span>
					...
					<div class="col-md-4">
						<div class="hp-call hp-right-com">
							<div class="hp-call-in"> <img src="{{ asset('bower_components/client_layout/images/icon/dbc4.png') }}" alt="">
								<h3><span>Check Availability. Call us!</span> +84 376 594 637</h3> <small>Chúng tôi hỗ trợ 24/7</small> <a href="#">Call Now</a> </div>
						</div>
						<div class="hp-book hp-right-com">
							<div class="hp-book-in">
								<button class="like-button"><i class="fa fa-heart-o"></i> Share room</button> <span>Atlantic Hotel</span>
								<ul>
						...
						<div class="hp-card hp-right-com">
							<div class="hp-card-in">
								<h3>We Accept</h3> <span>Atlantic Hotel</span> <img src="{{ asset('bower_components/client_layout/images/card.png') }}" alt=""> </div>
						</div>
					</div>
				</div>
			</div>
